...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-hair bg-ground/85 backdrop-blur">
      <div className="mx-auto flex w-full items-center gap-1 px-4 py-3 sm:px-6 lg:px-8">
        <Link
          href="/"
      ...
      {open && (
        <div className="border-t border-hair bg-ground/95 backdrop-blur md:hidden">
          <div className="mx-auto flex w-full flex-col gap-1 px-4 py-3 sm:px-6 lg:px-8">
            {links(true)}
